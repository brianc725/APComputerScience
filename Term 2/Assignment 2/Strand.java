...
public class Strand
{
 ...
 {
   for (Light multi:strand)
   {
    if(strand.indexOf(multi)%3 ==0)
      multi.setColor("red");
    if(strand.indexOf(multi)%3 == 1)
      multi.setColor("green");
    if(strand.indexOf(multi)%3 == 2)
      multi.setColor("blue");
   }
